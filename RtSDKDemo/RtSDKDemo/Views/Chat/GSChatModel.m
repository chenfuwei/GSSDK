...
- (instancetype)initWithModel:(GSChatMessage*)obj type:(GSChatModelType)type{
    if (self = [super init]) {
        ...
        if (obj) {
            ...
            NSAttributedString *attribute = [[GSChatContentParse sharedInstance] attributeStringFromHtml:obj.richText textFont:[UIFont fontWithName:@"Heiti SC" size:14.f] imageType:@"png"];
