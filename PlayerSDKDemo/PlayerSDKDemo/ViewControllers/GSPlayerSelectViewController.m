...
- (void)viewDidLoad {
    ...
    _titlesArray = @[NSLocalizedString(@"Video", @""), NSLocalizedString(@"Doc", @""), NSLocalizedString(@"Chat",@""), NSLocalizedString(@"Qa",@""), NSLocalizedString(@"Vote",@""),NSLocalizedString(@"Diagnosis",@""),NSLocalizedString(@"MoreInfo",@""), NSLocalizedString(@"Hongbao", @"")];
