...
//        [self.scrollView addSubview:label1];
    ...
    {
        //按钮事件 - 发布
        UIButton *download   = [[UIButton alloc] initWithFrame:CGRectMake(10.f, Height - 50.f + 5, (Width-40)/3, 40.f)];
...
//        历史下载
        ...
        //按钮事件 - 观看
        UIButton *watch   = [[UIButton alloc] initWithFrame:CGRectMake(30.f + 2*(Width-40)/3, Height - 50.f + 5, (Width-40)/3, 40.f)];
...
- (void)goDownload {
    ...
    if (!self.isTester){
        ...
        params.roomNumber = @"14949503";
        //    params.vodID = @"972a98d2baa845009fee2e454d19c29b";
        params.watchPassword = @"zs_s_secret_w";
...
- (void)goHistory {
    ...
    [[GSVodManager sharedInstance] request:params download:YES completion:^(downItem *item, GSVodWebaccessError type) {
        //添加好点播后进入点播下载记录列表
...
#else
//https://hqyzx.gensee.com/webcast/site/loginVodEnhanced?vodId=070cb5bc97d04527bb8a476a41cfeaeb&loginPassword=&password=&loginName=&nickName=KUANGTAO_hq_2f1e51e3581742aeacbeb2d2b2359a78&k=f800a45ab1ff123ea1cef751f4c61c4d&device=136&uid=1010906913&download=false

////    hqzk.gensee.com/webcast/site/vod/
    params.domain = @"cjl.gensee.com";
//    params.roomNumber = @"28017569";
    params.webcastID = @"oO3wUbyojI";
    params.watchPassword = @"171717";
    params.nickName = @"support";
...
//    params.serviceType = self.serviceType.selectedSegmentIndex == 0?@"webcast":@"training";;
    params.thirdToken = @"2D7D8BEB5440DFA8F3EFDCBE4F1790A3A8F9932BBDF9A7D2995DD4331237CB753F0EC25C61467F0F";
    params.oldVersion = NO;
    if ([self _fieldText:MO_USERID].length > 0) {
        params.customUserID = [[self _fieldText:MO_USERID] longLongValue];
    }
